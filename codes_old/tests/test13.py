...
def random_prim_ils_solution(ins, semilla = None, acceptance = 0.05, b = [1,0,0,0,0,0], mu = 0, alpha = 0,
    ...
    start = perf_counter()
    s, cost_best = random_prim_solution(ins)
...
def test(cap, nnodes ,pa, pb, lsp, e_param, f_param, elite_search_param ,iterMax, nombre):
    ...
    for inst in instances:
        ...
        solution_sum = 0
        for i in range(10):
            obj, time, best_bound, gap = random_prim_ils_solution(ins, semilla = i, pa = pa , pb = pb, lsp = lsp, 
...
if __name__ == "__main__":
    ...
    nnodes = 100
    for cap in caps:
        test(cap, nnodes, 0.4, 0.6, 0.8, 100, 250, 1500, 15000, f"Experimento 10 Q-{cap}")