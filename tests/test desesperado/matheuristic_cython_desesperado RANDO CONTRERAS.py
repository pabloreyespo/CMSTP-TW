...
def ILS_solution(ins, semilla = None, mu_acceptance = 0.032, alpha_unfeasible = 10000, beta_elite = 20000, 
                 elite_size = 20, iterMax = 15000,  initial_solution = None,
                 gamma_intensification = 6000, vis  = False, verbose = False, time_limit = 300, limit_type = "t"):
    global Q, D
...
if __name__ == "__main__":
    ...
    for q in capacities:
        ...
        nombre = f"MLM 60-40 RANDO CONTRERAS {global_time} Q-{q} n-{nnodes}"
        test(1/6,1/6, global_time, q, nnodes, ins_folder)