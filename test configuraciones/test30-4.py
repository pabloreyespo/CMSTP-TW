...
if __name__ == "__main__":
    argv = "-a 0.031 -f 9000 -e 20000 -s 20 -n 6.98 -x 0.093 -y 0.707 -z 0.157 -c 0.043 -r 6000 -u 0.073 -v 0.102 -w 0.824 -t 5"
    argv = argv.split()
    try:
    ...
    for q in capacities:
        ...
        nombre = f"3LM FINAL {gurobi_time}-4 Q-{q} n-{nnodes}"
