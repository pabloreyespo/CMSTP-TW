...
if __name__ == "__main__":
    argv = "-a 0.009 -f 19000 -e 5000 -s 40 -n 8.03 -x 0.082 -y 0.458 -z 0.389 -c 0.071 -r 5500 -u 0.135 -v 0.133 -w 0.732 -t 1"
    argv = argv.split()
    try:
    ...
    for q in capacities:
        ...
        nombre = f"3LM FINAL {gurobi_time}-2 Q-{q} n-{nnodes}"
