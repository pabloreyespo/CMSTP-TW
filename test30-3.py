...
if __name__ == "__main__":
    argv = "-a 0.01 -f 18000 -e 5000 -s 40 -n 7.937 -x 0.119 -y 0.486 -z 0.336 -c 0.06 -r 5500 -u 0.103 -v 0.161 -w 0.736 -t 1"
    argv = argv.split()
    try:
    ...
    for q in capacities:
        ...
        nombre = f"3LM FINAL {gurobi_time}-3 Q-{q} n-{nnodes}"
