...
def test(global_time, q, nnodes, ins_folder):
    ...
    for p in instances:
        ...
        tries = 10
        best_obj, avg_solution, avg_time =solver.run_test(tries = tries, time_limit=global_time, gurobi_time=40,meta_limit=260)
...
if __name__ == "__main__":
    ...
    for q in capacities:
        ...
        nombre = f"MLM ILS rev {global_time} Q-{q} n-{nnodes}"
